...
/**
 * Tags the 'smartassert.health_check_bundle.component_inspectors.version' service
 * with tag 'health_check_bundle.component_inspector.status'
 * if parameter 'health_check_bundle_enable_status_version_inspector'
 * resolves to boolean true.
 */
class TagStatusVersionInspectorCompilerPass implements CompilerPassInterface
{
    private const PARAMETER_NAME = 'health_check_bundle_enable_status_version_inspector';
    private const SERVICE_ID = 'smartassert.health_check_bundle.component_inspectors.version';
